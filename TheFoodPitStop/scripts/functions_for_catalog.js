...
function process_checkout(){
    var pickup_date = document.getElementById("pickup_date").innerHTML;
    var pickup_time="";
    ...
    xhttp.open("GET", "../index.php?content=payment&pickup_date=" + pickup_date + "&pickup_time=" + pickup_time, true);
}